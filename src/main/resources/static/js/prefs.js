(function () {
    ...
    const dict = {
        en: {
            ...
            'scores.title': 'Scores',
            'scores.subtitle': 'Pick session & class, then review score rows',
            'users.salary': 'Salary',
            ...
            'scores.sessionBtn': 'Score session',
            'scores.sessionTitle': 'Score session',
            'scores.sessionSubtitle': 'Enter scores for all students across class subjects',
            ...
            'scores.saveSession': 'Save scores',
            'scores.noStudents': 'No students in this class.',
            'scores.sessionPickClass': 'Select a class to load the score table.',
            'scores.sessionPickSubject': 'Enter a subject (and term) to load the score sheet.',
        ...
        km: {
            ...
            'scores.export': 'នានៅ Excel',
            'scores.import': 'នាំចូល Excel',
            'scores.add': 'បន្ថៃមពិន្ទុ',
            'scores.sessionBtn': 'វគ្គពិន្ទុ',
            'scores.sessionTitle': 'វគ្គពិន្ទុ',
            'scores.sessionSubtitle': 'បញ្ចូលពិន្ទុសម្រាប់សិស្សទាំងអស់តាមមុខវិជ្ជាថ្នាក់',
            'scores.pickHint': 'ជ្រើសរើសវគ្គសិក្សា និងថ្នាក់ ដើម្បីមើលពិន្ទុ។',
            'scores.session': 'ពាក់សិស្សី',
            'scores.subject': 'មុខវិជា',
            ...
            'scores.saveSession': 'រក្សាទុកពិន្ទុ',
            'scores.noStudents': 'មិនមានសិស្សក្នុងថ្នាក់នេះ។',
            'scores.sessionPickClass': 'ជ្រើសរើសថ្នាក់ដើម្បីផ្ទុកតារាងពិន្ទុ។',
            'scores.sessionPickSubject': 'បញ្ចូលមុខវិជ្ជា (និងពាក្យ) ដើម្បីបើកតារាងពិន្ទុ។',
